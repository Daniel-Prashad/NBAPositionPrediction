...
point_guards = ['steve nash', 'jason kidd', 'chris paul', 'tony parker', 'russell westbrook', 'luka doncic', 'trae young', 'ja morant', 'darius garland', 'lonzo ball',
                'damian lillard', 'derrick rose', 'jamal murray', 'kyrie irving', 'cameron payne', 'malcolm brogdon', 'fred vanvleet', 'dennis schroder', 'devonte graham', 'baron davis',
                'patrick beverley', 'mike conley jr', 'sam cassell', 'deron williams', 'shaun livingston', 'michael carter-williams', 'stephen curry', 'john stockton']

shooting_guards = ['allen iverson', 'dwayne wade', 'kobe bryant', 'tracy mcgrady','michael jordan', 'anthony edwards', 'tyler herro', 'devin booker', 'donovan mitchell', 'jordan poole',
                    'vince carter', 'demar derozan', 'klay thompson', 'terrence ross', 'cj mccollum', 'buddy hield', 'victor oladipo', 'caris lavert', 'michael redd', 'richard hamilton',
                    'jason terry', 'monta ellis', 'jason richardson', 'allan houston', 'morris peterson', 'tony allen', 'ron harper', 'zach lavine']

small_forwards = ['lebron james', 'paul pierce', 'scottie pippen', 'kevin durant', 'larry bird', 'jayson tatum', 'brandon ingram', 'andrew wiggins', 'michael porter jr', 'og anunoby',
...
power_forwards = ['kevin garnett', 'dirk nowitzki', 'dennis rodman', 'charles barkley', 'amar\'e stoudemire', 'pascal siakam', 'blake griffin', 'domantas sabonis', 'john collins', 'udonis haslem',
                    'draymond green', 'giannis antetokounmpo', 'zach randolph', 'kevin love', 'christian wood', 'aaron gordon', 'robert horry', 'kenya martin', 'serge ibaka', 'tristan thompson', 
...
centers = ['tim duncan', 'patrick ewing', 'pau gasol', 'nikola jokic', 'dikembe mutombo', 'bam adebayo', 'jarrett allen', 'karl-anthony towns', 'deandre ayton', 'myles turner',
            ...
            'ben wallace', 'vlade divac', 'andrew bynum', 'jeff foster', 'daniel theis', 'richaun holmes', 'dwight howard', 'chris bosh']
...
colours_five = {'PG': 'purple', 'SG': 'blue', 'SF': 'green', 'PF': 'orange', 'C':'red'}
